(function (global, factory) {
	...
	function encapsulateStyles(node) {
		setAttribute(node, "svelte-4091809081", "");
	}

	function add_css() {
		var style = createElement("style");
		style.id = 'svelte-4091809081-style';
		style.textContent = "[svelte-4091809081].change-password-dialog-container,[svelte-4091809081] .change-password-dialog-container{display:flex;align-items:center}[svelte-4091809081].change-password-dialog-container.layout-compact,[svelte-4091809081] .change-password-dialog-container.layout-compact{justify-content:center;position:fixed;top:0;left:0;bottom:0;right:0;z-index:1000}[svelte-4091809081].change-password-dialog-overlay,[svelte-4091809081] .change-password-dialog-overlay{display:none}[svelte-4091809081].change-password-dialog-container.layout-compact .change-password-dialog-overlay,[svelte-4091809081] .change-password-dialog-container.layout-compact .change-password-dialog-overlay{display:block;position:absolute;top:0;left:0;bottom:0;right:0;background-color:rgba(0, 0, 0, 0.1);z-index:1}[svelte-4091809081].change-password-dialog,[svelte-4091809081] .change-password-dialog{display:flex;flex-direction:column}[svelte-4091809081].change-password-dialog-container.layout-compact .change-password-dialog,[svelte-4091809081] .change-password-dialog-container.layout-compact .change-password-dialog{padding:2em;box-shadow:0px 5px 36px 0px rgba(0,0,0,0.25);background-color:#fff;max-height:80vh;max-width:80vw;overflow:auto;z-index:2}[svelte-4091809081].change-password-dialog-container.layout-compact .change-password-dialog.loading,[svelte-4091809081] .change-password-dialog-container.layout-compact .change-password-dialog.loading{width:90vw;height:90vh;max-width:260px;max-height:100px;justify-content:center;align-items:center}[svelte-4091809081].change-password-dialog-title,[svelte-4091809081] .change-password-dialog-title{padding-top:0;margin-top:0}[svelte-4091809081].close-button-container,[svelte-4091809081] .close-button-container{text-align:right;margin-top:1em}";
	...
	function TilmeldChangePassword(options) {
		...
		if (!document.getElementById("svelte-4091809081-style")) add_css();
