(function (global, factory) {
	...
	function encapsulateStyles(node) {
		setAttribute(node, "svelte-1742704354", "");
	}

	function add_css() {
		var style = createElement("style");
		style.id = 'svelte-1742704354-style';
		style.textContent = "[svelte-1742704354].login-dialog-container,[svelte-1742704354] .login-dialog-container{display:flex;align-items:center}[svelte-1742704354].login-dialog-container.layout-compact,[svelte-1742704354] .login-dialog-container.layout-compact{justify-content:center;position:fixed;top:0;left:0;bottom:0;right:0;z-index:1000}[svelte-1742704354].login-dialog-overlay,[svelte-1742704354] .login-dialog-overlay{display:none}[svelte-1742704354].login-dialog-container.layout-compact .login-dialog-overlay,[svelte-1742704354] .login-dialog-container.layout-compact .login-dialog-overlay{display:block;position:absolute;top:0;left:0;bottom:0;right:0;background-color:rgba(0, 0, 0, 0.1);z-index:1}[svelte-1742704354].login-dialog,[svelte-1742704354] .login-dialog{display:flex;flex-direction:column}[svelte-1742704354].login-dialog-container.layout-compact .login-dialog,[svelte-1742704354] .login-dialog-container.layout-compact .login-dialog{padding:2em;box-shadow:0px 5px 36px 0px rgba(0,0,0,0.25);background-color:#fff;max-height:80vh;max-width:80vw;overflow:auto;z-index:2}[svelte-1742704354].login-dialog-container.layout-compact .login-dialog.loading,[svelte-1742704354] .login-dialog-container.layout-compact .login-dialog.loading{width:90vw;height:90vh;max-width:260px;max-height:100px;justify-content:center;align-items:center}[svelte-1742704354].login-dialog-title,[svelte-1742704354] .login-dialog-title{padding-top:0;margin-top:0}[svelte-1742704354].close-button-container,[svelte-1742704354] .close-button-container{text-align:right;margin-top:1em}";
	...
	function TilmeldLogin(options) {
		...
		if (!document.getElementById("svelte-1742704354-style")) add_css();
