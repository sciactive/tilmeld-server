...
var TilmeldLogin = (function(Nymph, User, TilmeldRecover) { "use strict";
  ...
  this.observe('username', checkUsername);
	...
	function encapsulateStyles(node) {
		setAttribute(node, "svelte-1223938294", "");
	}

	function add_css() {
		var style = createElement("style");
		style.id = 'svelte-1223938294-style';
		style.textContent = "[svelte-1223938294].login-dialog-container,[svelte-1223938294] .login-dialog-container{display:flex;align-items:center}[svelte-1223938294].login-dialog-container.layout-compact,[svelte-1223938294] .login-dialog-container.layout-compact{justify-content:center;position:fixed;top:0;left:0;bottom:0;right:0;z-index:1000}[svelte-1223938294].login-dialog-overlay,[svelte-1223938294] .login-dialog-overlay{display:none}[svelte-1223938294].login-dialog-container.layout-compact .login-dialog-overlay,[svelte-1223938294] .login-dialog-container.layout-compact .login-dialog-overlay{display:block;position:absolute;top:0;left:0;bottom:0;right:0;background-color:rgba(0, 0, 0, 0.1);z-index:1}[svelte-1223938294].login-dialog,[svelte-1223938294] .login-dialog{display:flex;flex-direction:column}[svelte-1223938294].login-dialog-container.layout-compact .login-dialog,[svelte-1223938294] .login-dialog-container.layout-compact .login-dialog{padding:2em;box-shadow:0px 5px 36px 0px rgba(0,0,0,0.25);background-color:#fff;max-height:80vh;max-width:80vw;overflow:auto;z-index:2}[svelte-1223938294].login-dialog-container.layout-compact .login-dialog.loading,[svelte-1223938294] .login-dialog-container.layout-compact .login-dialog.loading{width:90vw;height:90vh;max-width:260px;max-height:100px;justify-content:center;align-items:center}";
	...
	// (47:8) {{#if __clientConfig.allow_registration && showExistingUserCheckbox}}
	...
	// (59:14) {{#if __clientConfig.email_usernames}}
	...
	// (65:16) {{#if layout === 'small' || layout === 'compact'}}
	...
	// (68:16) {{#if __usernameVerifiedMessage}}
	...
	// (64:14) {{#if !existingUser}}
	function create_if_block_14(state, component) {
		var text, if_block_1_anchor;

		var if_block = (state.layout === 'small' || state.layout === 'compact') && create_if_block_15(state, component);

		var if_block_1 = (state.__usernameVerifiedMessage) && create_if_block_16(state, component);
	...
	// (88:10) {{#if __clientConfig.reg_fields.indexOf('name') !== -1}}
	...
	// (96:10) {{#if !__clientConfig.email_usernames && __clientConfig.reg_fields.indexOf('email') !== -1}}
	...
	// (104:10) {{#if __clientConfig.reg_fields.indexOf('phone') !== -1}}
	...
	// (120:20) {{#each __clientConfig.timezones as tz}}
	...
	// (112:10) {{#if __clientConfig.reg_fields.indexOf('timezone') !== -1}}
	...
	// (128:10) {{#if __clientConfig.reg_fields.indexOf('address') !== -1}}
	...
	// (81:8) {{#if __clientConfig.allow_registration && !existingUser}}
	function create_if_block_17(state, component) {
		...
		var if_block = (state.__clientConfig.reg_fields.indexOf('name') !== -1) && create_if_block_18(state, component);

		var if_block_1 = (!state.__clientConfig.email_usernames && state.__clientConfig.reg_fields.indexOf('email') !== -1) && create_if_block_19(state, component);

		var if_block_2 = (state.__clientConfig.reg_fields.indexOf('phone') !== -1) && create_if_block_20(state, component);

		var if_block_3 = (state.__clientConfig.reg_fields.indexOf('timezone') !== -1) && create_if_block_21(state, component);

		var if_block_4 = (state.__clientConfig.reg_fields.indexOf('address') !== -1) && create_if_block_22(state, component);
			...
			p: function update(changed, state) {
				...
				if (state.__clientConfig.reg_fields.indexOf('name') !== -1) {
					if (if_block) {
						...
						if_block = create_if_block_18(state, component);
						if_block.c();
				...
				if (!state.__clientConfig.email_usernames && state.__clientConfig.reg_fields.indexOf('email') !== -1) {
					if (if_block_1) {
						...
						if_block_1 = create_if_block_19(state, component);
						if_block_1.c();
				...
				if (state.__clientConfig.reg_fields.indexOf('phone') !== -1) {
					if (if_block_2) {
						...
						if_block_2 = create_if_block_20(state, component);
						if_block_2.c();
				...
				if (state.__clientConfig.reg_fields.indexOf('timezone') !== -1) {
					if (if_block_3) {
						...
						if_block_3 = create_if_block_21(state, component);
						if_block_3.c();
				...
				if (state.__clientConfig.reg_fields.indexOf('address') !== -1) {
					if (if_block_4) {
						...
						if_block_4 = create_if_block_22(state, component);
						if_block_4.c();
	...
	// (200:8) {{#if !hideRecovery && __clientConfig.pw_recovery && existingUser}}
	...
	function create_if_block_10(state, component) {
		var form, form_class_value, text, div, label, span, text_1_value = state.__clientConfig.email_usernames ? 'Email' : 'Username', text_1, text_2, span_1, span_1_class_value, text_3, text_7, div_1, label_1, span_2, text_9, input, input_updating = false, text_12, text_13, text_14, div_2, div_2_class_value, text_15, text_17;

		var if_block = (state.__clientConfig.allow_registration && state.showExistingUserCheckbox) && create_if_block_11(state, component);

		var current_block_type = select_block_type_1(state);
		var if_block_1 = current_block_type(state, component);

		var if_block_2 = (!state.existingUser) && create_if_block_14(state, component);
		...
		var if_block_3 = (state.__clientConfig.allow_registration && !state.existingUser) && create_if_block_17(state, component);

		var if_block_4 = (state.__failureMessage) && create_if_block_25(state, component);

		var current_block_type_1 = select_block_type_3(state);
		var if_block_5 = current_block_type_1(state, component);

		var if_block_6 = (state.layout === 'compact') && create_if_block_28(state, component);

		var if_block_7 = (!state.hideRecovery && state.__clientConfig.pw_recovery && state.existingUser) && create_if_block_29(state, component);
		...
		return {
			...
			m: function mount(target, anchor) {
				...
				if (if_block_6) if_block_6.m(div_2, null);
				appendNode(text_17, form);
				if (if_block_7) if_block_7.m(form, null);
			},
			...
			p: function update(changed, state) {
				...
				if (!state.existingUser) {
					if (if_block_2) {
						...
						if_block_2 = create_if_block_14(state, component);
						if_block_2.c();
				...
				if (state.__clientConfig.allow_registration && !state.existingUser) {
					if (if_block_3) {
						...
						if_block_3 = create_if_block_17(state, component);
						if_block_3.c();
				...
				if (state.__failureMessage) {
					if (if_block_4) {
						...
						if_block_4 = create_if_block_25(state, component);
						if_block_4.c();
				...
				if (current_block_type_1 !== (current_block_type_1 = select_block_type_3(state))) {
					if_block_5.u();
					if_block_5.d();
					if_block_5 = current_block_type_1(state, component);
					if_block_5.c();
					if_block_5.m(div_2, text_15);
				}

				if (state.layout === 'compact') {
					if (!if_block_6) {
						if_block_6 = create_if_block_28(state, component);
						if_block_6.c();
	...
	function select_block_type_1(state) {
		if (state.__clientConfig.email_usernames) return create_if_block_12;
		return create_if_block_13;
	}

	function select_block_type_2(state) {
		if (state.addressType === 'us') return create_if_block_23;
		return create_if_block_24;
	}

	function select_block_type_3(state) {
		if (state.existingUser) return create_if_block_26;
	...
	function TilmeldLogin(options) {
		...
		if (!document.getElementById("svelte-1223938294-style")) add_css();
