/* src/Components/TilmeldRecover.html generated by Svelte v1.41.2 */
var TilmeldRecover = (function(Nymph, User) { "use strict";
  ...
  this.observe('__showDialog', (value) => {
	...
	function encapsulateStyles(node) {
		setAttribute(node, "svelte-1491544881", "");
	}

	function add_css() {
		var style = createElement("style");
		style.id = 'svelte-1491544881-style';
		style.textContent = "[svelte-1491544881].recovery-dialog-container,[svelte-1491544881] .recovery-dialog-container{display:flex;align-items:center}[svelte-1491544881].recovery-dialog-container.layout-compact,[svelte-1491544881] .recovery-dialog-container.layout-compact{justify-content:center;position:fixed;top:0;left:0;bottom:0;right:0;z-index:1000}[svelte-1491544881].recovery-dialog-overlay,[svelte-1491544881] .recovery-dialog-overlay{display:none}[svelte-1491544881].recovery-dialog-container.layout-compact .recovery-dialog-overlay,[svelte-1491544881] .recovery-dialog-container.layout-compact .recovery-dialog-overlay{display:block;position:absolute;top:0;left:0;bottom:0;right:0;background-color:rgba(0, 0, 0, 0.3);z-index:1}[svelte-1491544881].recovery-dialog,[svelte-1491544881] .recovery-dialog{display:flex;flex-direction:column}[svelte-1491544881].recovery-dialog-container.layout-compact .recovery-dialog,[svelte-1491544881] .recovery-dialog-container.layout-compact .recovery-dialog{padding:2em;box-shadow:0px 5px 36px 0px rgba(0,0,0,0.25);background-color:#fff;max-height:80vh;max-width:80vw;overflow:auto;z-index:2}[svelte-1491544881].recovery-dialog-container.layout-compact .recovery-dialog.loading,[svelte-1491544881] .recovery-dialog-container.layout-compact .recovery-dialog.loading{width:90vw;height:90vh;max-width:260px;max-height:100px;justify-content:center;align-items:center}[svelte-1491544881].recovery-dialog-title,[svelte-1491544881] .recovery-dialog-title{padding-top:0;margin-top:0}";
	...
	// (29:10) {{#if !__clientConfig.email_usernames}}
	...
	// (37:12) {{#if recoveryType === 'password'}}
	function create_if_block_6(state, component) {
		var p, text, text_1_value = state.__clientConfig.email_usernames ? 'email' : 'username', text_1, text_2;
	...
	// (40:12) {{#if recoveryType === 'username'}}
	...
	// (46:14) {{#if recoveryType === 'password'}}
	function create_if_block_8(state, component) {
		var span, text_value = state.__clientConfig.email_usernames ? 'Email Address' : 'Username', text;
	...
	// (49:14) {{#if recoveryType === 'username'}}
	...
	// (28:8) {{#if !__hasSentSecret}}
	function create_if_block_4(state, component) {
		var text, div, text_1, text_3, div_1, label, text_4, text_5, input, input_updating = false;
	...
	function create_if_block_10(state, component) {
		var div, label, span, text_1, input, input_updating = false, text_4, div_1, label_1, span_1, text_6, input_1, input_1_updating = false;
		...
		function input_1_input_handler() {
			...
			component.set({ password2: input_1.value });
		...
		return {
			c: function create() {
				...
				span_1.textContent = "Re-enter Password";
				text_6 = createText("\n              ");
				input_1 = createElement("input");
				this.h();
			},
	...
	function create_if_block_3(state, component) {
		var form, div, text_2, text_3, div_1, div_1_class_value, text_4, button;

		var current_block_type = select_block_type(state);
		var if_block = current_block_type(state, component);

		var if_block_1 = (!state.__hasSentSecret) && create_if_block_11(state, component);
		...
		return {
			...
			h: function hydrate() {
				...
				div_1.className = div_1_class_value = "pf-element " + (state.layout === 'small' ? '' : 'pf-buttons');
				button.className = "pf-button";
				addListener(button, "click", click_handler);
			},
			...
			p: function update(changed, state) {
				...
				if ((changed.layout) && div_1_class_value !== (div_1_class_value = "pf-element " + (state.layout === 'small' ? '' : 'pf-buttons'))) {
					div_1.className = div_1_class_value;
				}

				if (!state.__hasSentSecret) {
					if (!if_block_1) {
						if_block_1 = create_if_block_11(state, component);
						if_block_1.c();
						if_block_1.m(div_1, text_4);
					}
				} else if (if_block_1) {
					if_block_1.u();
					if_block_1.d();
	...
	function TilmeldRecover(options) {
		...
		if (!document.getElementById("svelte-1491544881-style")) add_css();
