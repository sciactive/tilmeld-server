(function (global, factory) {
	...
	function encapsulateStyles(node) {
		setAttribute(node, "svelte-2936863861", "");
	}

	function add_css() {
		var style = createElement("style");
		style.id = 'svelte-2936863861-style';
		style.textContent = "[svelte-2936863861].recovery-dialog-container,[svelte-2936863861] .recovery-dialog-container{display:flex;align-items:center}[svelte-2936863861].recovery-dialog-container.layout-compact,[svelte-2936863861] .recovery-dialog-container.layout-compact{justify-content:center;position:fixed;top:0;left:0;bottom:0;right:0;z-index:1000}[svelte-2936863861].recovery-dialog-overlay,[svelte-2936863861] .recovery-dialog-overlay{display:none}[svelte-2936863861].recovery-dialog-container.layout-compact .recovery-dialog-overlay,[svelte-2936863861] .recovery-dialog-container.layout-compact .recovery-dialog-overlay{display:block;position:absolute;top:0;left:0;bottom:0;right:0;background-color:rgba(0, 0, 0, 0.1);z-index:1}[svelte-2936863861].recovery-dialog,[svelte-2936863861] .recovery-dialog{display:flex;flex-direction:column}[svelte-2936863861].recovery-dialog-container.layout-compact .recovery-dialog,[svelte-2936863861] .recovery-dialog-container.layout-compact .recovery-dialog{padding:2em;box-shadow:0px 5px 36px 0px rgba(0,0,0,0.25);background-color:#fff;max-height:80vh;max-width:80vw;overflow:auto;z-index:2}[svelte-2936863861].recovery-dialog-container.layout-compact .recovery-dialog.loading,[svelte-2936863861] .recovery-dialog-container.layout-compact .recovery-dialog.loading{width:90vw;height:90vh;max-width:260px;max-height:100px;justify-content:center;align-items:center}[svelte-2936863861].recovery-dialog-title,[svelte-2936863861] .recovery-dialog-title{padding-top:0;margin-top:0}[svelte-2936863861].close-button-container,[svelte-2936863861] .close-button-container{text-align:right;margin-top:1em}";
	...
	function create_if_block_5(state, component) {
		var div, span, text_1, label, input, input_class_value, text_2, text_3, label_1, input_1, input_1_class_value, text_4;
	...
	function create_if_block_4(state, component) {
		...
		return {
			...
			p: function update(changed, state) {
				...
				if (!input_updating) input.value = state.account;
	...
	function create_if_block_10(state, component) {
		...
		return {
			...
			p: function update(changed, state) {
				if (!input_updating) input.value = state.secret;
				if (changed.classInput && input_class_value !== (input_class_value = "pf-field " + state.classInput)) {
					input.className = input_class_value;
				}
	...
	function create_if_block_2(state, component) {
		var div, div_1, text, text_2, div_2, button, button_class_value;
	...
	function create_if_block_3(state, component) {
		var form, div, text_2, text_3, text_4, div_1, text_5, button, button_class_value;
	...
	function TilmeldRecover(options) {
		...
		if (!document.getElementById("svelte-2936863861-style")) add_css();
