...
if (\Tilmeld\Tilmeld::$config->email_usernames['value'])
...
<form class="pf-form" id="p_muid_form" method="post" action="<?php e(pines_url('com_user', 'recover')); ?>">
	...
	<div class="pf-element pf-heading">
		<p class="toggle password">To reset your password, type your <?php echo \Tilmeld\Tilmeld::$config->email_usernames['value'] ? 'email' : 'username'; ?> you use to sign in below.</p>
	...
	<div class="pf-element">
		<label>
			<span class="pf-label toggle password"><?php echo \Tilmeld\Tilmeld::$config->email_usernames['value'] ? 'Email Address' : 'Username'; ?></span>
